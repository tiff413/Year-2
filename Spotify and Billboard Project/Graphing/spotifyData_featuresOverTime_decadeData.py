...
# TAKE AVERAGES OF FEATURES FOR EVERY DECADE
...
df_mean2 = df_mean[[
        "decade", "acousticness", "danceability", "energy", "instrumentalness",
        "speechiness", "valence"
        ]]
...
fig.update_layout(
    ...
    xaxis = go.layout.XAxis(
        tickmode = 'array',
        tickvals = [1960, 1970, 1980, 1990, 2000, 2010],
        ticktext = ["1960's", "1970's", "1980's", "1990's", "2000's", "2010's"]
    ),
    title = {
            'text': "<b>Spotify audio features of Billboard Hot 100 songs (per decade)</b>",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'
...
py.iplot(fig, filename='spotifyData_featuresOverTime_decadeData')
fig.show()
