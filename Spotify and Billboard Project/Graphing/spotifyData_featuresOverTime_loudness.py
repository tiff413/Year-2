...
df_mean2 = df_mean[["year", "loudness"]]
...
fig.update_layout(
    ...
    title = {
            'text': "Average loudness level of Billboard Year End Hot 100 songs (1980-2019)",
            'y':0.9,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'
...
py.iplot(fig, filename='spotifyData_loudnessOverTime_2LRs')
fig.show()
